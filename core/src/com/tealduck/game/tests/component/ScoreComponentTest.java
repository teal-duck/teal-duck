...
public class ScoreComponentTest {
	...
	public void testGetComboTimeForCombo() {
		...
		ScoreComponent scoreComponent = new ScoreComponent();
		Assert.assertEquals(scoreComponent.getComboTimeForCombo(0), 4.75, ScoreComponentTest.DELTA);
		Assert.assertEquals(scoreComponent.getComboTimeForCombo(1), 4.0, ScoreComponentTest.DELTA);
		Assert.assertEquals(scoreComponent.getComboTimeForCombo(2), 2.75, ScoreComponentTest.DELTA);
		Assert.assertEquals(scoreComponent.getComboTimeForCombo(3), 1.0, ScoreComponentTest.DELTA);
		Assert.assertEquals(scoreComponent.getComboTimeForCombo(4), 0.4, ScoreComponentTest.DELTA); // fails?
														// Dunno
														// why.
														// Should
														// run
		Assert.assertEquals(scoreComponent.getComboTimeForCombo(5), 0.4, ScoreComponentTest.DELTA); // also
														// fails.
														// Same
														// as
														// above.
	...
	public void testFinishCombo() {
		...
		Assert.assertEquals(scoreComponent.comboTime, 0, ScoreComponentTest.DELTA);
	...
	public void testComboCountdown() {
		...
		Assert.assertEquals(scoreComponent.comboTime, 2.0f, ScoreComponentTest.DELTA);
